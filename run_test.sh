...
main() {
    ...
    if python webbench.py --config config.yaml --projects projects.yaml; then
        ...
        echo "  • Performance (15%): Core Web Vitals, loading speed"
        echo "  • Accessibility (11%): WCAG compliance, screen reader support"
        echo "  • Code Quality (11%): ESLint errors/warnings count"
        echo "  • Build Time (11%): Production build duration"
        echo "  • Bundle Size (11%): Final distribution size"
